...
import {
  FRACTION_BLUEPRINT_HASH,
  FRACTION_POLICY_BLUEPRINT_HASH,
...
export const SCRIPT_BUILD_ID = [
  ...
  `f${String(FRACTION_VAULT_VERSION)}${FRACTION_BLUEPRINT_HASH.slice(0, 12)}`,
  `fp${FRACTION_POLICY_BLUEPRINT_HASH.slice(0, 12)}`,
].join("-");
