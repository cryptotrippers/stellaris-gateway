...
Generated 2026-08-31T02:05:48.324Z against **Preprod**. Produced by `bun run test:dapp` (`scripts/dapp-readiness.mjs`), read-only.

**Score: 15% on chain** — 5 live, 22 wired-but-unproven, 6 not implemented.
...
| PASS | yield_vault / ph-solar-01 | hash caff856c166b4ad54e949e2dfd13daff9303ed9f6e289027a5c4402e · on chain · cbor EXACT MATCH — live script is the pinned blueprint · 3 utxo(s) at addr_test1wr90lptvze45442wjj0zmlgnmtlexqldnahz3yp85hzyqtsqygj9m |
...
| WARN | multi_asset_vault / sfm-01 / USDr (placeholder policy) | derived 29e207da8e077c95425813ab2fd03aa5e785b2922fdef1d5dd39455b — never seen on chain (addr addr_test1wq57yp763crhe92ztqf6kt7s82j70pdjjghaauw4m5u52kct3tq47) — USDr has an empty policy id in deposit_assets, so it derives the ADA address — no real token vault exists for it |
...
| WARN | multi_asset_vault / ph-solar-01 / USDr (placeholder policy) | derived f758cc8146a8a2539f68844c87e23519ca48bd0d64fb2c0bd0251164 — never seen on chain (addr addr_test1wrm43nypg652y5uldzzyeplzx5vu5j9ap4j0ktqt6qj3zeqy6ansy) — USDr has an empty policy id in deposit_assets, so it derives the ADA address — no real token vault exists for it |
...
| WARN | multi_asset_vault / sfm-02 / USDr (placeholder policy) | derived 2cb42d9ea01feb9073184ea3e42728b4397652cf70289176e75393a6 — never seen on chain (addr addr_test1wqktgtv75q07hyrnrp828ep89z6rjajjeacz3ytkuafe8fste5pzt) — USDr has an empty policy id in deposit_assets, so it derives the ADA address — no real token vault exists for it |
...
| | Item | Evidence |
| --- | --- | --- |
| PASS | sfm-01 state UTxO | 1 state + 0 position utxo(s) of 1 at addr_test1wzu3553l3sh6ptgnmprvejw0dzgmugs06dxz6p9alrg0yqsgd9h47 · bootstrap 929444ef0eea5c29fd216e880592e07632f4be4a22bd2f2ad0ac84f1eb387f27 |
| WARN | ph-solar-01 state UTxO | 2 state + 1 position utxo(s) of 3 at addr_test1wr90lptvze45442wjj0zmlgnmtlexqldnahz3yp85hzyqtsqygj9m · bootstrap 7ace1152a3d49f8692d77823f9c4e532d2254c179e05670d5143cd4e4a9ce28e · duplicate state: 00581fdd67330f3921fd2738fff7c505320a8435c1ebaf6d206e52f58393687d#0, 36d2b4743332096c67af898858d5e0ecf999a1df9fc419da180cab921effa59a#0 — spend the superseded bootstrap state to restore the sole-state rule |
| PASS | sfm-02 state UTxO | 1 state + 0 position utxo(s) of 1 at addr_test1wr8wwtqslhrypx33qqhwzavzg4prs2mq7ql0g3x5mvgfs3ch0htln · bootstrap 661b36317f1de360f3c1f1a9a3f48cc53f0efbe1bc365892fd1d9b9d3287d1aa |
...
| multi_asset_vault / sfm-01 / USDr (placeholder policy) | `29e207da8e077c95425813ab2fd03aa5e785b2922fdef1d5dd39455b` | `addr_test1wq57yp763crhe92ztqf6kt7s82j70pdjjghaauw4m5u52kct3tq47` |
...
| multi_asset_vault / ph-solar-01 / USDr (placeholder policy) | `f758cc8146a8a2539f68844c87e23519ca48bd0d64fb2c0bd0251164` | `addr_test1wrm43nypg652y5uldzzyeplzx5vu5j9ap4j0ktqt6qj3zeqy6ansy` |
...
| multi_asset_vault / sfm-02 / USDr (placeholder policy) | `2cb42d9ea01feb9073184ea3e42728b4397652cf70289176e75393a6` | `addr_test1wqktgtv75q07hyrnrp828ep89z6rjajjeacz3ytkuafe8fste5pzt` |
