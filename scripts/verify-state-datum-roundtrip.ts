...
const samples: VaultStateDatum[] = [
  {
    ...
    epoch: 7,
    operators: [
      "aabbccddeeff00112233445566778899aabbccddeeff0011223344",
      "112233445566778899aabbccddeeff00112233445566778899aabb",
    ],
    threshold: 2,
    paused: true,
    feeBps: 250,
    treasury: "deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbee",
    treasuryShares: "42",
  ...
  // Bootstrap-shaped: zeroed accounting, single operator, unpaused.
  {
    ...
    totalAssets: "0",
    epoch: 0,
    operators: ["00112233445566778899aabbccddeeff00112233445566778899aa"],
    threshold: 1,
    paused: false,
    feeBps: 0,
    treasury: "",
